export interface paths {
  ...
  "/api/v1/account/2fa": {
    ...
    /**
     * Return 2FA status for current account
     * @description GET /api/v1/account/2fa
     */
    get: operations["GET__api_v1_account_2fa"];
    put?: never;
    post?: never;
    delete?: never;
    options?: never;
  ...
  "/api/v1/admin/sessions/revoke_all": {
     ...
     * @description POST /api/v1/admin/sessions/revoke_all
     *     Emergency kill-switch that forces every currently authenticated user to re-authenticate.
     */
    post: operations["POST__api_v1_admin_sessions_revoke_all"];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
  ...
  "/api/v1/age_gate/accept": {
    ...
    put?: never;
    /**
     * Accept 18+ age gate for the current session
     * @description POST /api/v1/age_gate/accept
     *     Stores age-gate acceptance on the current session token.
     */
    post: operations["POST__api_v1_age_gate_accept"];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
  ...
  "/api/v1/checkout/success": {
     ...
     * @description Returns the current status of the checkout session without mutating state.
     */
  ...
  "/api/v1/csrf": {
    ...
    /**
     * Returns CSRF token for SPA clients
     * @description GET /api/v1/csrf
     */
    get: operations["GET__api_v1_csrf"];
    put?: never;
    post?: never;
    delete?: never;
    options?: never;
  ...
  "/api/v1/diagnostics/auth": {
    ...
    /** Report auth-related diagnostics for the current request */
    get: operations["GET__api_v1_diagnostics_auth"];
    put?: never;
    post?: never;
    delete?: never;
    options?: never;
  ...
  "/api/v1/health": {
    ...
    /** View */
    get: operations["GET__api_v1_health"];
    put?: never;
    post?: never;
    delete?: never;
    options?: never;
  ...
  "/cable/health": {
    ...
    /** View */
    get: operations["GET__cable_health"];
    put?: never;
    post?: never;
    delete?: never;
    options?: never;
...
export interface components {
  schemas: {
    ...
    "0a0e2448eab89240bf530c2bb78e3ac9": components["schemas"]["AccountExportData"];
    ...
    "26f86f43c05fa9b7ad191b4a812ac567": {
      reason?: string;
      revoked_at?: string;
      rotate_signing_secrets?: boolean;
      secret_rotation_note?: string;
    ...
    "3d1ba37e32b58330567554ed8607e48d": components["schemas"]["AccountTwoFactorVerifyResponse"];
    ...
    "674aaed99c273be7c0cd2898b2e4ebed": {
      reason?: string;
      rotate_signing_secrets?: boolean;
    };
    ...
    "9716253bdd9047e146dd2c947db9ac87": components["schemas"]["AccountTwoFactorDisableResponse"];
    ...
    UserSession: {
      /** @description JWT used for authenticated requests when bearer auth is enabled. */
      access_token?: string;
      /** @description Refresh token for bearer-token clients when bearer auth is enabled. */
      refresh_token?: string;
      session_token_id: number | string;
      user: components["schemas"]["User"];
    };
    ...
    a1915689d62452760d2d6379f731a54c: components["schemas"]["LoggedInStatus"];
    ...
    d51ee01d42ed6338e9e7caeec9bf5005: components["schemas"]["AccountTwoFactorSetupResponse"];
    d79407304a1f91dbdcfa03f0d06dc75e: {
      error?: string;
      status: number;
    };
    dd72c824eb71f0d8640f5edb1efdda81: {
      csrf_token?: string;
    };
    ...
    f6c6b763e26f0487f0a719378896ca6d: components["schemas"]["AccountTwoFactorStatusResponse"];
  ...
  responses: {
    ...
    resp_002: {
      ...
      content: {
        "application/json": components["schemas"]["0a0e2448eab89240bf530c2bb78e3ac9"];
      };
    };
    ...
    resp_006: {
      ...
      content: {
        "application/json": components["schemas"]["5bb19a086e9077f5192683c8c05feaa9"];
      };
    };
    ...
    resp_033: {
      ...
      content: {
        "application/json": components["schemas"]["26f86f43c05fa9b7ad191b4a812ac567"];
      };
    };
    ...
    resp_035: {
      ...
      content: {
        "application/json": components["schemas"]["a1915689d62452760d2d6379f731a54c"];
      };
    };
    /** @description Success */
    resp_036: {
    ...
    resp_039: {
      ...
      content: {
        "application/json": components["schemas"]["3d1ba37e32b58330567554ed8607e48d"];
      };
    };
    ...
    resp_047: {
      ...
      content: {
        "application/json": components["schemas"]["f6c6b763e26f0487f0a719378896ca6d"];
      };
    };
    ...
    resp_060: {
      ...
      content: {
        "application/json": components["schemas"]["dd72c824eb71f0d8640f5edb1efdda81"];
      };
    };
  ...
  requestBodies: {
    ...
    /** @description Global revoke request */
    req_013: {
      content: {
        "application/json": components["schemas"]["674aaed99c273be7c0cd2898b2e4ebed"];
      };
    };
...
export interface operations {
  ...
  GET__api_v1_account: {
    ...
    requestBody?: never;
    responses: {
      200: components["responses"]["resp_073"];
      401: components["responses"]["resp_071"];
      403: components["responses"]["resp_051"];
      404: components["responses"]["resp_046"];
  ...
  POST__api_v1_account_2fa_disable: {
    ...
    requestBody: components["requestBodies"]["req_017"];
    responses: {
  ...
  POST__api_v1_account_data_export: {
    ...
    responses: {
      ...
      401: components["responses"]["resp_071"];
      403: components["responses"]["resp_051"];
      422: components["responses"]["resp_055"];
      500: components["responses"]["resp_023"];
    };
  };
  "POST__api_v1_account_email-change": {
    ...
    responses: {
      202: components["responses"]["resp_070"];
      401: components["responses"]["resp_071"];
      403: components["responses"]["resp_051"];
      422: components["responses"]["resp_018"];
      429: components["responses"]["resp_068"];
      500: components["responses"]["resp_023"];
    };
  };
  ...
  "DELETE__api_v1_account_sessions_{id}": {
    ...
    responses: {
      200: components["responses"]["resp_041"];
      401: components["responses"]["resp_071"];
      403: components["responses"]["resp_058"];
      404: components["responses"]["resp_046"];
      422: components["responses"]["resp_018"];
      500: components["responses"]["resp_023"];
    };
  ...
  POST__api_v1_admin_auctions: {
    ...
    responses: {
      201: components["responses"]["resp_069"];
      401: components["responses"]["resp_071"];
      403: components["responses"]["resp_058"];
      422: components["responses"]["resp_048"];
      500: components["responses"]["resp_023"];
  ...
  "DELETE__api_v1_admin_auctions_{id}": {
    ...
    requestBody?: never;
    responses: {
      204: components["responses"]["resp_066"];
      401: components["responses"]["resp_071"];
      403: components["responses"]["resp_058"];
      404: components["responses"]["resp_003"];
      422: components["responses"]["resp_048"];
  ...
  "POST__api_v1_admin_fulfillments_{id}_complete": {
    ...
    requestBody?: never;
    responses: {
      401: components["responses"]["resp_044"];
      403: components["responses"]["resp_051"];
      500: components["responses"]["resp_023"];
    };
  };
  ...
  POST__api_v1_admin_sessions_revoke_all: {
    parameters: {
      query?: never;
      header?: never;
      path?: never;
  ...
  "POST__api_v1_auctions_{auction_id}_bids": {
    ...
    requestBody?: never;
    responses: {
      200: components["responses"]["resp_065"];
      401: components["responses"]["resp_071"];
      403: components["responses"]["resp_058"];
      404: components["responses"]["resp_003"];
      422: components["responses"]["resp_048"];
  ...
  POST__api_v1_signup: {
    ...
    responses: {
      ...
      422: components["responses"]["resp_067"];
    };
  };
