      ...
      <section className="py-20 px-6 text-center">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
           {[
            ...
            { name: "Eric Vierhaus", title: "Assistant to the Client Pleasure Advocate", description: "Eric is your go-to for any query, ensuring your XBid experience is nothing short of blissful and always discreet.", img: "https://placehold.co/150x150/1a0d2e/ff69b4?text=EV", borderColor: "border-pink-500", titleColor: "text-pink-400" }
          ].map((member) => (
