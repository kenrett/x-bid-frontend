...
export function Auction({
  ...
  return (
    <button
      ...
      type="button"
      onClick={() => onClick(id)}
      className={`group block w-full text-left bg-[color:var(--sf-surface)] border border-[color:var(--sf-border)] rounded-[var(--sf-radius)] overflow-hidden shadow-[var(--sf-shadow)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[var(--sf-shadow)] focus:outline-none focus:ring-2 focus:ring-[color:var(--sf-primary)] focus:ring-offset-2 focus:ring-offset-[color:var(--sf-background)] animate-[fadeInUp_0.5s_ease-out_both] ${delayClass}`}
    >
      <img
      ...
      />
      <div className="p-5">
        <h2 className="text-2xl font-bold mb-2 text-[color:var(--sf-text)] truncate">
          {title}
        </h2>
